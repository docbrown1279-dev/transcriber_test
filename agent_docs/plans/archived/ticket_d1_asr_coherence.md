...
**Статус:** CLOSED / archived (2026-09-06) — C3+agg был промежуточный; superseded by Silero parity ticket (`archived/ticket_d1_silero_parity.md`).  
**Было:** DONE (C3 + merge agg in `config/base.yaml`; merged to main)  
