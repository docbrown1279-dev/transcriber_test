...
| [`3b/`](3b/notes.md) | этап 3b **закрыт**: инсайты D (Gemini), `report.md`; локальный assemble тех же инсайтов |
| [`3c/`](3c/notes.md) | этап 3c **закрыт**: фильтр инсайтов D; Gemini потолок, Qwen8B черновик; report follow-up |
