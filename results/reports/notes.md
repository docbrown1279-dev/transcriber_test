...
| [`1f2/`](1f2/) | этап 1f2: 3 VAD + 3 эмбеддера (прогон) |

Канонические JSON: `results/reports/1a/` … `1e/`, `2/`. Прогон 2b: ветка `cursor/stage2b-four-hypotheses-4305`.
План: [`docs/research_plan.md`](../../docs/research_plan.md), итог 2b: [`2b/conclusions.md`](2b/conclusions.md), итог 3: [`3/notes.md`](3/notes.md), итог 1f: [`1f/notes.md`](1f/notes.md), промпт 1f2: [`docs/prompts/stage1f2_vad.md`](../../docs/prompts/stage1f2_vad.md).
